...
#         'NAME': config('DB_NAME', default='milkman_db'),
...
# Respect reverse proxy headers (Render) so absolute URLs are generated with https.
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:3000",
    "http://127.0.0.1:5173",
    "https://sahil-final-milkman.vercel.app",
]
...
# For local development you can keep console backend.
# To send real mails set EMAIL_BACKEND to:
